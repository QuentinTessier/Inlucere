...
// API:        GL_VERSION_4_6
// Profile:    core
// Extensions: GL_ARB_sparse_texture, GL_ARB_bindless_texture, GL_NV_mesh_shader, GL_EXT_semaphore
//

//
// This file was generated with the following command line:
// generator C:\Users\quent\Documents\Code\zig-opengl\bin\Debug\net7.0\generator.dll .\OpenGL-Registry\xml\gl.xml gl4_6.zig GL_VERSION_4_6 GL_ARB_sparse_texture GL_ARB_bindless_texture GL_NV_mesh_shader GL_EXT_semaphore
//
...
pub const GL_ARB_sparse_texture = struct {
    ...
    pub fn texPageCommitmentARB(_target: GLenum, _level: GLint, _xoffset: GLint, _yoffset: GLint, _zoffset: GLint, _width: GLsizei, _height: GLsizei, _depth: GLsizei, _commit: GLboolean) callconv(.C) void {
        return @call(.always_tail, function_pointers.glTexPageCommitmentARB, .{ _target, _level, _xoffset, _yoffset, _zoffset, _width, _height, _depth, _commit });
    }

    pub fn load(load_ctx: anytype, get_proc_address: fn (@TypeOf(load_ctx), [:0]const u8) ?FunctionPointer) !void {
        var success = true;
        if (get_proc_address(load_ctx, "glTexPageCommitmentARB")) |proc| {
            function_pointers.glTexPageCommitmentARB = @ptrCast(proc);
        } else {
            log.err("entry point glTexPageCommitmentARB not found!", .{});
            success = false;
        }
        if (!success)
            return error.EntryPointNotFound;
...
pub const GL_EXT_semaphore = struct {
    ...
    pub fn getUnsignedBytevEXT(_pname: GLenum, _data: [*c]GLubyte) callconv(.C) void {
        return @call(.always_tail, function_pointers.glGetUnsignedBytevEXT, .{ _pname, _data });
    }

    pub fn getUnsignedBytei_vEXT(_target: GLenum, _index: GLuint, _data: [*c]GLubyte) callconv(.C) void {
        return @call(.always_tail, function_pointers.glGetUnsignedBytei_vEXT, .{ _target, _index, _data });
    }

    pub fn genSemaphoresEXT(_n: GLsizei, _semaphores: [*c]GLuint) callconv(.C) void {
        return @call(.always_tail, function_pointers.glGenSemaphoresEXT, .{ _n, _semaphores });
    }

    pub fn deleteSemaphoresEXT(_n: GLsizei, _semaphores: [*c]const GLuint) callconv(.C) void {
        return @call(.always_tail, function_pointers.glDeleteSemaphoresEXT, .{ _n, _semaphores });
    }

    pub fn isSemaphoreEXT(_semaphore: GLuint) callconv(.C) GLboolean {
        return @call(.always_tail, function_pointers.glIsSemaphoreEXT, .{_semaphore});
    }

    pub fn semaphoreParameterui64vEXT(_semaphore: GLuint, _pname: GLenum, _params: [*c]const GLuint64) callconv(.C) void {
        return @call(.always_tail, function_pointers.glSemaphoreParameterui64vEXT, .{ _semaphore, _pname, _params });
    }

    pub fn getSemaphoreParameterui64vEXT(_semaphore: GLuint, _pname: GLenum, _params: [*c]GLuint64) callconv(.C) void {
        return @call(.always_tail, function_pointers.glGetSemaphoreParameterui64vEXT, .{ _semaphore, _pname, _params });
    }

    pub fn waitSemaphoreEXT(_semaphore: GLuint, _numBufferBarriers: GLuint, _buffers: [*c]const GLuint, _numTextureBarriers: GLuint, _textures: [*c]const GLuint, _srcLayouts: [*c]const GLenum) callconv(.C) void {
        return @call(.always_tail, function_pointers.glWaitSemaphoreEXT, .{ _semaphore, _numBufferBarriers, _buffers, _numTextureBarriers, _textures, _srcLayouts });
    }

    pub fn signalSemaphoreEXT(_semaphore: GLuint, _numBufferBarriers: GLuint, _buffers: [*c]const GLuint, _numTextureBarriers: GLuint, _textures: [*c]const GLuint, _dstLayouts: [*c]const GLenum) callconv(.C) void {
        return @call(.always_tail, function_pointers.glSignalSemaphoreEXT, .{ _semaphore, _numBufferBarriers, _buffers, _numTextureBarriers, _textures, _dstLayouts });
    }

    pub fn load(load_ctx: anytype, get_proc_address: fn (@TypeOf(load_ctx), [:0]const u8) ?FunctionPointer) !void {
        var success = true;
        if (get_proc_address(load_ctx, "glGetUnsignedBytevEXT")) |proc| {
            function_pointers.glGetUnsignedBytevEXT = @ptrCast(proc);
        } else {
            log.err("entry point glGetUnsignedBytevEXT not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glGetUnsignedBytei_vEXT")) |proc| {
            function_pointers.glGetUnsignedBytei_vEXT = @ptrCast(proc);
        } else {
            log.err("entry point glGetUnsignedBytei_vEXT not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glGenSemaphoresEXT")) |proc| {
            function_pointers.glGenSemaphoresEXT = @ptrCast(proc);
        } else {
            log.err("entry point glGenSemaphoresEXT not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glDeleteSemaphoresEXT")) |proc| {
            function_pointers.glDeleteSemaphoresEXT = @ptrCast(proc);
        } else {
            log.err("entry point glDeleteSemaphoresEXT not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glIsSemaphoreEXT")) |proc| {
            function_pointers.glIsSemaphoreEXT = @ptrCast(proc);
        } else {
            log.err("entry point glIsSemaphoreEXT not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glSemaphoreParameterui64vEXT")) |proc| {
            function_pointers.glSemaphoreParameterui64vEXT = @ptrCast(proc);
        } else {
            log.err("entry point glSemaphoreParameterui64vEXT not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glGetSemaphoreParameterui64vEXT")) |proc| {
            function_pointers.glGetSemaphoreParameterui64vEXT = @ptrCast(proc);
        } else {
            log.err("entry point glGetSemaphoreParameterui64vEXT not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glWaitSemaphoreEXT")) |proc| {
            function_pointers.glWaitSemaphoreEXT = @ptrCast(proc);
        } else {
            log.err("entry point glWaitSemaphoreEXT not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glSignalSemaphoreEXT")) |proc| {
            function_pointers.glSignalSemaphoreEXT = @ptrCast(proc);
        } else {
            log.err("entry point glSignalSemaphoreEXT not found!", .{});
            success = false;
        }
        if (!success)
            return error.EntryPointNotFound;
...
pub const GL_NV_mesh_shader = struct {
    ...
    pub fn drawMeshTasksNV(_first: GLuint, _count: GLuint) callconv(.C) void {
        return @call(.always_tail, function_pointers.glDrawMeshTasksNV, .{ _first, _count });
    }

    pub fn drawMeshTasksIndirectNV(_indirect: GLintptr) callconv(.C) void {
        return @call(.always_tail, function_pointers.glDrawMeshTasksIndirectNV, .{_indirect});
    }

    pub fn multiDrawMeshTasksIndirectNV(_indirect: GLintptr, _drawcount: GLsizei, _stride: GLsizei) callconv(.C) void {
        return @call(.always_tail, function_pointers.glMultiDrawMeshTasksIndirectNV, .{ _indirect, _drawcount, _stride });
    }

    pub fn multiDrawMeshTasksIndirectCountNV(_indirect: GLintptr, _drawcount: GLintptr, _maxdrawcount: GLsizei, _stride: GLsizei) callconv(.C) void {
        return @call(.always_tail, function_pointers.glMultiDrawMeshTasksIndirectCountNV, .{ _indirect, _drawcount, _maxdrawcount, _stride });
    }

    pub fn load(load_ctx: anytype, get_proc_address: fn (@TypeOf(load_ctx), [:0]const u8) ?FunctionPointer) !void {
        var success = true;
        if (get_proc_address(load_ctx, "glDrawMeshTasksNV")) |proc| {
            function_pointers.glDrawMeshTasksNV = @ptrCast(proc);
        } else {
            log.err("entry point glDrawMeshTasksNV not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glDrawMeshTasksIndirectNV")) |proc| {
            function_pointers.glDrawMeshTasksIndirectNV = @ptrCast(proc);
        } else {
            log.err("entry point glDrawMeshTasksIndirectNV not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glMultiDrawMeshTasksIndirectNV")) |proc| {
            function_pointers.glMultiDrawMeshTasksIndirectNV = @ptrCast(proc);
        } else {
            log.err("entry point glMultiDrawMeshTasksIndirectNV not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glMultiDrawMeshTasksIndirectCountNV")) |proc| {
            function_pointers.glMultiDrawMeshTasksIndirectCountNV = @ptrCast(proc);
        } else {
            log.err("entry point glMultiDrawMeshTasksIndirectCountNV not found!", .{});
            success = false;
        }
        if (!success)
            return error.EntryPointNotFound;
...
const function_signatures = struct {
    ...
    const glTexPageCommitmentARB = fn (_target: GLenum, _level: GLint, _xoffset: GLint, _yoffset: GLint, _zoffset: GLint, _width: GLsizei, _height: GLsizei, _depth: GLsizei, _commit: GLboolean) callconv(.C) void;
    const glGetUnsignedBytevEXT = fn (_pname: GLenum, _data: [*c]GLubyte) callconv(.C) void;
    const glGetUnsignedBytei_vEXT = fn (_target: GLenum, _index: GLuint, _data: [*c]GLubyte) callconv(.C) void;
    const glGenSemaphoresEXT = fn (_n: GLsizei, _semaphores: [*c]GLuint) callconv(.C) void;
    const glDeleteSemaphoresEXT = fn (_n: GLsizei, _semaphores: [*c]const GLuint) callconv(.C) void;
    const glIsSemaphoreEXT = fn (_semaphore: GLuint) callconv(.C) GLboolean;
    const glSemaphoreParameterui64vEXT = fn (_semaphore: GLuint, _pname: GLenum, _params: [*c]const GLuint64) callconv(.C) void;
    const glGetSemaphoreParameterui64vEXT = fn (_semaphore: GLuint, _pname: GLenum, _params: [*c]GLuint64) callconv(.C) void;
    const glWaitSemaphoreEXT = fn (_semaphore: GLuint, _numBufferBarriers: GLuint, _buffers: [*c]const GLuint, _numTextureBarriers: GLuint, _textures: [*c]const GLuint, _srcLayouts: [*c]const GLenum) callconv(.C) void;
    const glSignalSemaphoreEXT = fn (_semaphore: GLuint, _numBufferBarriers: GLuint, _buffers: [*c]const GLuint, _numTextureBarriers: GLuint, _textures: [*c]const GLuint, _dstLayouts: [*c]const GLenum) callconv(.C) void;
    const glDrawMeshTasksNV = fn (_first: GLuint, _count: GLuint) callconv(.C) void;
    const glDrawMeshTasksIndirectNV = fn (_indirect: GLintptr) callconv(.C) void;
    const glMultiDrawMeshTasksIndirectNV = fn (_indirect: GLintptr, _drawcount: GLsizei, _stride: GLsizei) callconv(.C) void;
    const glMultiDrawMeshTasksIndirectCountNV = fn (_indirect: GLintptr, _drawcount: GLintptr, _maxdrawcount: GLsizei, _stride: GLsizei) callconv(.C) void;
};
...
const function_pointers = struct {
    ...
    var glTexPageCommitmentARB: *const function_signatures.glTexPageCommitmentARB = undefined;
    var glGetUnsignedBytevEXT: *const function_signatures.glGetUnsignedBytevEXT = undefined;
    var glGetUnsignedBytei_vEXT: *const function_signatures.glGetUnsignedBytei_vEXT = undefined;
    var glGenSemaphoresEXT: *const function_signatures.glGenSemaphoresEXT = undefined;
    var glDeleteSemaphoresEXT: *const function_signatures.glDeleteSemaphoresEXT = undefined;
    var glIsSemaphoreEXT: *const function_signatures.glIsSemaphoreEXT = undefined;
    var glSemaphoreParameterui64vEXT: *const function_signatures.glSemaphoreParameterui64vEXT = undefined;
    var glGetSemaphoreParameterui64vEXT: *const function_signatures.glGetSemaphoreParameterui64vEXT = undefined;
    var glWaitSemaphoreEXT: *const function_signatures.glWaitSemaphoreEXT = undefined;
    var glSignalSemaphoreEXT: *const function_signatures.glSignalSemaphoreEXT = undefined;
    var glDrawMeshTasksNV: *const function_signatures.glDrawMeshTasksNV = undefined;
    var glDrawMeshTasksIndirectNV: *const function_signatures.glDrawMeshTasksIndirectNV = undefined;
    var glMultiDrawMeshTasksIndirectNV: *const function_signatures.glMultiDrawMeshTasksIndirectNV = undefined;
    var glMultiDrawMeshTasksIndirectCountNV: *const function_signatures.glMultiDrawMeshTasksIndirectCountNV = undefined;
};
