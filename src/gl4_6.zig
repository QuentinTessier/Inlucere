...
// API:        GL_VERSION_4_6
// Profile:    core
// Extensions: GL_ARB_sparse_texture, GL_ARB_sparse_buffer, GL_ARB_bindless_texture, GL_ARB_indirect_parameters, GL_ARB_parallel_shader_compile, GL_KHR_shader_subgroup
//

//
// This file was generated with the following command line:
// generator C:\Users\quent\Code\zig-opengl\bin\Debug\net7.0\generator.dll .\OpenGL-Registry\xml\gl.xml gl4_6.zig GL_VERSION_4_6 GL_ARB_sparse_texture GL_ARB_sparse_buffer GL_ARB_bindless_texture GL_ARB_indirect_parameters GL_ARB_parallel_shader_compile GL_KHR_shader_subgroup
//
...
pub const GL_ARB_indirect_parameters = struct {
    pub const PARAMETER_BUFFER_ARB = 0x80EE;
    pub const PARAMETER_BUFFER_BINDING_ARB = 0x80EF;

    pub fn multiDrawArraysIndirectCountARB(_mode: GLenum, _indirect: ?*const anyopaque, _drawcount: GLintptr, _maxdrawcount: GLsizei, _stride: GLsizei) callconv(.c) void {
        return @call(.always_tail, function_pointers.glMultiDrawArraysIndirectCountARB, .{ _mode, _indirect, _drawcount, _maxdrawcount, _stride });
    }

    pub fn multiDrawElementsIndirectCountARB(_mode: GLenum, _type: GLenum, _indirect: ?*const anyopaque, _drawcount: GLintptr, _maxdrawcount: GLsizei, _stride: GLsizei) callconv(.c) void {
        return @call(.always_tail, function_pointers.glMultiDrawElementsIndirectCountARB, .{ _mode, _type, _indirect, _drawcount, _maxdrawcount, _stride });
    }

    pub fn load(load_ctx: anytype, get_proc_address: fn (@TypeOf(load_ctx), [:0]const u8) ?FunctionPointer) !void {
        var success = true;
        if (get_proc_address(load_ctx, "glMultiDrawArraysIndirectCountARB")) |proc| {
            function_pointers.glMultiDrawArraysIndirectCountARB = @ptrCast(proc);
        } else {
            log.err("entry point glMultiDrawArraysIndirectCountARB not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glMultiDrawElementsIndirectCountARB")) |proc| {
            function_pointers.glMultiDrawElementsIndirectCountARB = @ptrCast(proc);
        } else {
            log.err("entry point glMultiDrawElementsIndirectCountARB not found!", .{});
            success = false;
        }
        if (!success)
            return error.EntryPointNotFound;
...
pub const GL_ARB_parallel_shader_compile = struct {
    pub const MAX_SHADER_COMPILER_THREADS_ARB = 0x91B0;
    pub const COMPLETION_STATUS_ARB = 0x91B1;

    pub fn maxShaderCompilerThreadsARB(_count: GLuint) callconv(.c) void {
        return @call(.always_tail, function_pointers.glMaxShaderCompilerThreadsARB, .{_count});
    }

    pub fn load(load_ctx: anytype, get_proc_address: fn (@TypeOf(load_ctx), [:0]const u8) ?FunctionPointer) !void {
        var success = true;
        if (get_proc_address(load_ctx, "glMaxShaderCompilerThreadsARB")) |proc| {
            function_pointers.glMaxShaderCompilerThreadsARB = @ptrCast(proc);
        } else {
            log.err("entry point glMaxShaderCompilerThreadsARB not found!", .{});
            success = false;
        }
        if (!success)
            return error.EntryPointNotFound;
...
pub const GL_ARB_sparse_buffer = struct {
    pub const SPARSE_STORAGE_BIT_ARB = 0x0400;
    pub const SPARSE_BUFFER_PAGE_SIZE_ARB = 0x82F8;

    pub fn bufferPageCommitmentARB(_target: GLenum, _offset: GLintptr, _size: GLsizeiptr, _commit: GLboolean) callconv(.c) void {
        return @call(.always_tail, function_pointers.glBufferPageCommitmentARB, .{ _target, _offset, _size, _commit });
    }

    pub fn namedBufferPageCommitmentEXT(_buffer: GLuint, _offset: GLintptr, _size: GLsizeiptr, _commit: GLboolean) callconv(.c) void {
        return @call(.always_tail, function_pointers.glNamedBufferPageCommitmentEXT, .{ _buffer, _offset, _size, _commit });
    }

    pub fn namedBufferPageCommitmentARB(_buffer: GLuint, _offset: GLintptr, _size: GLsizeiptr, _commit: GLboolean) callconv(.c) void {
        return @call(.always_tail, function_pointers.glNamedBufferPageCommitmentARB, .{ _buffer, _offset, _size, _commit });
    }

    pub fn load(load_ctx: anytype, get_proc_address: fn (@TypeOf(load_ctx), [:0]const u8) ?FunctionPointer) !void {
        var success = true;
        if (get_proc_address(load_ctx, "glBufferPageCommitmentARB")) |proc| {
            function_pointers.glBufferPageCommitmentARB = @ptrCast(proc);
        } else {
            log.err("entry point glBufferPageCommitmentARB not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glNamedBufferPageCommitmentEXT")) |proc| {
            function_pointers.glNamedBufferPageCommitmentEXT = @ptrCast(proc);
        } else {
            log.err("entry point glNamedBufferPageCommitmentEXT not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glNamedBufferPageCommitmentARB")) |proc| {
            function_pointers.glNamedBufferPageCommitmentARB = @ptrCast(proc);
        } else {
            log.err("entry point glNamedBufferPageCommitmentARB not found!", .{});
            success = false;
        }
        if (!success)
            return error.EntryPointNotFound;
...
pub const GL_KHR_shader_subgroup = struct {
    ...
    pub fn load(load_ctx: anytype, _: fn (@TypeOf(load_ctx), [:0]const u8) ?FunctionPointer) !void {
        const success = true;
        if (!success)
            return error.EntryPointNotFound;
    }
...
const function_signatures = struct {
    ...
    const glMultiDrawArraysIndirectCountARB = fn (_mode: GLenum, _indirect: ?*const anyopaque, _drawcount: GLintptr, _maxdrawcount: GLsizei, _stride: GLsizei) callconv(.c) void;
    const glMultiDrawElementsIndirectCountARB = fn (_mode: GLenum, _type: GLenum, _indirect: ?*const anyopaque, _drawcount: GLintptr, _maxdrawcount: GLsizei, _stride: GLsizei) callconv(.c) void;
    const glMaxShaderCompilerThreadsARB = fn (_count: GLuint) callconv(.c) void;
    const glBufferPageCommitmentARB = fn (_target: GLenum, _offset: GLintptr, _size: GLsizeiptr, _commit: GLboolean) callconv(.c) void;
    const glNamedBufferPageCommitmentEXT = fn (_buffer: GLuint, _offset: GLintptr, _size: GLsizeiptr, _commit: GLboolean) callconv(.c) void;
    const glNamedBufferPageCommitmentARB = fn (_buffer: GLuint, _offset: GLintptr, _size: GLsizeiptr, _commit: GLboolean) callconv(.c) void;
...
const function_pointers = struct {
    ...
    var glMultiDrawArraysIndirectCountARB: *const function_signatures.glMultiDrawArraysIndirectCountARB = undefined;
    var glMultiDrawElementsIndirectCountARB: *const function_signatures.glMultiDrawElementsIndirectCountARB = undefined;
    var glMaxShaderCompilerThreadsARB: *const function_signatures.glMaxShaderCompilerThreadsARB = undefined;
    var glBufferPageCommitmentARB: *const function_signatures.glBufferPageCommitmentARB = undefined;
    var glNamedBufferPageCommitmentEXT: *const function_signatures.glNamedBufferPageCommitmentEXT = undefined;
    var glNamedBufferPageCommitmentARB: *const function_signatures.glNamedBufferPageCommitmentARB = undefined;
